...
export const testRegistry: TestDefinition[] = [
  ...
  },
  {
    ...
    title: "Validate capability protocol and action replay queue",
    status: "implemented",
    spec: "tests/playwright/specs/agent.protocol.spec.ts",
    details: "Verifies capability manifest validation, permission policy, input rejection, and serialized visible mutations with concurrent queries.",
  },
  {
    id: "agent.app-controllers",
    feature: "AI Assistant",
    title: "Exercise app controllers through deterministic agent paths",
    status: "implemented",
    spec: "tests/playwright/specs/app.controllers.spec.ts",
    details: "Covers virtual Files search/list/open, Notes write/append/read/clear, and Music queue/play selection behavior without a Pi model.",
  },
  {
    id: "ai.assistant.disconnected",
    feature: "AI Assistant",
    title: "Show disconnected state without a Pi backend",
    status: "implemented",
    spec: "tests/playwright/specs/ai.assistant.spec.ts",
    details: "Opens AI Assistant and verifies the disconnected state disables prompt submission instead of faking a model response.",
  },
  {
    id: "ai.assistant.persistence",
    feature: "AI Assistant",
    title: "Persist and resume multiple local chats",
    status: "implemented",
    spec: "tests/playwright/specs/ai.assistant.spec.ts",
