...
export const testRegistry: TestDefinition[] = [
  ...
  {
    id: "window.keyboard.move-resize",
    feature: "Window manager",
    title: "Move and resize the focused window with the keyboard",
    status: "implemented",
    spec: "tests/playwright/specs/window.keyboard.spec.ts",
    details: "Verify Alt+Arrow moves and Control+Alt+Arrow resizes the focused window.",
  },
  {
    id: "window.dock.left",
    feature: "Window manager",
  ...
  {
    id: "desktop.icon.layout",
    feature: "Desktop",
    title: "Place desktop icons deterministically within usable bounds",
    status: "implemented",
    spec: "tests/playwright/specs/desktop.behavior.spec.ts",
    details: "Verify icon cells are deterministic, unique, and remain above the taskbar.",
  },
  {
    id: "persistence.malformed",
    feature: "Persistence",
    title: "Recover from malformed persisted desktop values",
    status: "implemented",
    spec: "tests/playwright/specs/desktop.behavior.spec.ts",
    details: "Verify malformed icon, theme, and custom-background values safely use defaults.",
  },
  {
  ...
  },
  {
    ...
    status: "implemented",
    spec: "tests/playwright/specs/personalization.spec.ts",
  ...
  {
    id: "notes.persistence.malformed",
    feature: "Notes",
    title: "Recover from malformed persisted editor state",
    status: "implemented",
    spec: "tests/playwright/specs/notes.files.spec.ts",
    details: "Verify invalid saved editor state falls back to a functional empty note.",
  },
  {
  ...
  },
  {
    ...
    status: "implemented",
    spec: "tests/playwright/specs/pdf.open.spec.ts",
